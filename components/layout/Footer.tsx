      ...
      <div className="footer-top">
        <div>
          ...
          <p className="footer-tagline">
            Premium home fragrance handpoured in small batches across India.
            Every candle is an invitation to slow down.
          </p>
        ...
        <nav className="footer-nav" aria-label="Footer navigation">
          <div className="footer-nav-col">
            ...
            <ul className="footer-nav-list">
              ...
              <li><Link href="/collections/morning-calm" className="footer-nav-link">Morning Calm</Link></li>
              <li><Link href="/collections/evening-ritual" className="footer-nav-link">Evening Ritual</Link></li>
              <li><Link href="/collections/monsoon-noir" className="footer-nav-link">Monsoon Noir</Link></li>
              <li><Link href="/gifting" className="footer-nav-link">Gift Sets</Link></li>
            </ul>
          </div>
          <div className="footer-nav-col">
            ...
            <ul className="footer-nav-list">
              ...
              <li><Link href="/gifting" className="footer-nav-link">Gifting</Link></li>
